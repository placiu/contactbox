...
{
    /**
     * @ORM\ManyToOne(targetEntity="Address", inversedBy="people")
     ...
     * @return Person
     */
    public function setAddress(\ContactBundle\Entity\Address $address = null)
    {
     ...
     * Get address
     *
     * @return \ContactBundle\Entity\Address
     */
